// Zippy, by Jaime Olivares
// Website: Zippy.codeplex.com
...
namespace System.IO.Compression
{
    ...
    /// </summary>
    public class Zippy : IDisposable
    {
        /// <summary>
        ...
        /// <returns>A valid Zippy object</returns>
        public static Zippy Create(string _filename, string _comment)
        {
            Stream stream = new FileStream(_filename, FileMode.Create, FileAccess.ReadWrite);

            Zippy zip = Create(stream, _comment);
        ...
        /// <returns>A valid Zippy object</returns>
        public static Zippy Create(Stream _stream, string _comment)
        {
            Zippy zip = new Zippy();
            zip.Comment = _comment;
        ...
        /// <returns>A valid Zippy object</returns>
        public static Zippy Open(Stream _stream, FileAccess _access)
        {
        ...
        public static bool RemoveEntries(ref Zippy _zip, List<ZipFileEntry> _zfes)
        {
            ...
            try
            {
                Zippy tempZip = Zippy.Create(tempZipName, string.Empty);
                ...
                _zip = Zippy.Open(_zip.FileName, _zip.Access);
            }
            catch
            {
                return false;
        ...
        private void Store(ref ZipFileEntry _zfe, Stream _source)
        {
            ...
            do
            {
                ...
                if (bytesRead > 0)
                {
                    ...
                    {
                        _zfe.Crc32 = Zippy.CrcTable[(_zfe.Crc32 ^ buffer[i]) & 0xFF] ^ (_zfe.Crc32 >> 8);
                    }
                }
